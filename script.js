...
document.addEventListener('DOMContentLoaded', function() {
    // Set three-column layout as default on page load
    ...
    // Initialize with three columns (already the default in CSS now)
    threeColumnBtn.classList.add('active');
    twoColumnBtn.classList.remove('active');
    
    // Toggle layout when buttons are clicked
